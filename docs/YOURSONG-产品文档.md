...
版本 v0.5 · 2026-08-17 · 状态：Landing 已上线可分享；Make a song 五步流程已梳理，待你拍板后开工
...
Make a song（/make · 一个编辑器 + 顶部三格 step）
...
2. 选唱片机外观：哑光黑（默认）/ 银灰 / 木纹 / 亚克力
3. 可见性：**Public**（进 Landing 公共墙）/ **Unlisted**（有链接就能听）/ **Private**
4. 压片动画 → 唱片落进你的架子 → 直接跳到你的页面
